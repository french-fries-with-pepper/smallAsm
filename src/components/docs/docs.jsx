    ...
    <main className="docs siteMain">
      ...
      <article className="docs__article">
        ...
        <p className="docs__articleText">
          Small Asm is a simple assembler interpreter, written in JavaScript.
          Actually, this is frontend for my solution of{" "}
          <a
        ...
        <p className="docs__articleText">
          There are no OS emulation, but it has some I/O tools. Syntax very
          similar to Intel. Interpreter has instructions, labels, functions and
          jmp conditions. Comments and indentation are also available.
        </p>
        <p className="docs__articleText">
          It is possible to use any register name (without spaces and
          non-alphanumeric characters). In examples i use register names same as
          the{" "}
          <a
          ...
          (A, B, D, H, C, E, L). There are no register extension logic. One
          ...
          <ul>
            ...
            <li>
              ...
              <span>
                ...
                the register x and stores the result in x (i.e. register[x] -=
                y).
              </span>
            </li>
            <li>
              <code>mul x, y</code>
              <span>- same with multiply (i.e. register[x] *= y).</span>
            </li>

            <li>
              <code>cmp x, y</code>
              <span>
                - compares x (either an integer or the value of a register) and
                y (either an integer or the value of a register). The result is
                used in the conditional jumps (jne, je, jge, jg, jle and jl)
              </span>
            </li>
            ...
            <li>
              ...
              <span>
                ...
                The number of arguments isn't limited and will vary, depending
                on the program.
              </span>
            </li>
            <li>
              <code>end</code>
              <span>
                - this instruction indicates that the program ends correctly, so
                the stored output is returned (if the program terminates without
                this instruction it will return error code).
              </span>
            </li>
            <li>
              <code>; comment</code>
        ...
        <h3 className="docs__articleHeader">Control flow</h3>
          <ul>
            ...
            <li>
              <code>jne lbl</code>
              <span>
                - jump to the label <code>lbl</code>if the values of the
                previous <code>cmp</code>command were not equal.
              </span>
            </li>
            <li>
              <code>je lbl</code>
              <span>
                - jump to the label <code>lbl</code>if the values of the
                previous <code>cmp</code>command were equal.
              </span>
            </li>
            <li>
              <code>jge lbl</code>
            ...
            <li>
              <code>jle lbl</code>
              <span>
                - jump to the label <code>lbl</code>if x was less or equal than
                y in the previous <code>cmp</code>command.
              </span>
            </li>
            <li>
              <code>jl lbl</code>
            ...
            <li>
              ...
              <span>
                ...
                <code>ret</code>is found in a subroutine, the instruction
                pointer will be returned to the instruction next to this{" "}
            ...
            <li>
              <code>ret</code>
              <span>
                - when a <code>ret</code>is found in a subroutine, the
                instruction pointer will be returned to the instruction that
